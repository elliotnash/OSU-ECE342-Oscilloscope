...
export const buttonStyles = tv({
  base: [
    ...
    "*:data-[slot=color-swatch]:-mx-0.5 *:data-[slot=color-swatch]:shrink-0 *:data-[slot=color-swatch]:self-center *:data-[slot=color-swatch]:[--color-swatch-size:--spacing(5)] transition-colors",
  ],
  variants: {
    intent: {
      primary:
